...
export const de: I18n = {
  ...
  'Global (all agents)': 'Global (alle Agenten)',
  ...
  'Select an agent to view and edit their memory':
    'Wählen Sie einen Agenten, um sein Gedächtnis anzuzeigen und zu bearbeiten',
  'Memory for {agent}': 'Gedächtnis von {agent}',
  'This is what the agent remembers across conversations. It is injected at the start of every chat. Edit it freely.':
    'Das merkt sich der Agent über Gespräche hinweg. Es wird zu Beginn jedes Chats eingefügt. Bearbeiten Sie es frei.',
  'The agent has no memory yet. It will fill this in as you chat, or you can write notes here yourself.':
    'Der Agent hat noch kein Gedächtnis. Er füllt es beim Chatten, oder Sie können hier selbst Notizen schreiben.',
  characters: 'Zeichen',
  Compact: 'Verdichten',
  ...
  'Edit memory': 'Gedächtnis bearbeiten',
  'Write what this agent should remember, as short notes…': 'Schreiben Sie als kurze Notizen, was sich dieser Agent merken soll…',
  ...
  'Remember for this agent': 'Für diesen Agenten merken',
  'Remember for all agents': 'Für alle Agenten merken',
  'Remember selection': 'Auswahl merken',
  'Selection actions': 'Auswahlaktionen',
  'Added to this agent’s memory': 'Zum Gedächtnis dieses Agenten hinzugefügt',
  'Added to global memory': 'Zum globalen Gedächtnis hinzugefügt',
  'Failed to save to memory': 'Speichern im Gedächtnis fehlgeschlagen',
  'No agent selected for this memory': 'Kein Agent für diese Erinnerung ausgewählt',
  ...
  'Search tasks and conversations…': 'Aufgaben und Unterhaltungen suchen…',
  'No threads yet': 'Noch keine Threads',
  'No matching threads': 'Keine passenden Threads',
  'Select a thread to preview': 'Thread zur Vorschau auswählen',
  'to navigate': 'zum Navigieren',
  'No content': 'Kein Inhalt',
  'Conversation Envelope': 'Gesprächsumschlag',
  Task: 'Aufgabe',
  ...
  'New agent': 'Neuer Agent',
  'Create a custom agent': 'Benutzerdefinierten Agenten erstellen',

  // AgentCreationWizard
  'How would you like to create your agent?': 'Wie möchten Sie Ihren Agenten erstellen?',
  'Choose your preferred approach. You can always switch later.': 'Wählen Sie Ihren bevorzugten Ansatz. Sie können später jederzeit wechseln.',
  'AI-Assisted': 'KI-unterstützt',
  'Describe what kind of agent you need in plain language. AI will generate the name, role, and instructions for you.': 'Beschreiben Sie in einfacher Sprache, welchen Agenten Sie brauchen. Die KI generiert Name, Rolle und Anweisungen für Sie.',
  'Manual Configuration': 'Manuelle Konfiguration',
  'Set up everything yourself. Define the name, role, and instructions from scratch.': 'Richten Sie alles selbst ein. Definieren Sie Name, Rolle und Anweisungen von Grund auf.',
  'Describe your agent': 'Beschreiben Sie Ihren Agenten',
  'Tell us what kind of agent you want and we\u2019ll generate its name, role, and instructions automatically.': 'Sagen Sie uns, welchen Agenten Sie möchten, und wir generieren Name, Rolle und Anweisungen automatisch.',
  'Generating agent...': 'Agent wird generiert...',
  'Thinking...': 'Denkt nach...',
  'Stop': 'Stopp',
  'Generate Agent': 'Agent generieren',
  'to generate': 'zum Generieren',
  'Skip to manual': 'Zum manuellen Modus',
  'Agent configuration': 'Agent-Konfiguration',
  'Define your agent\u2019s identity and behavior. All fields are editable.': 'Definieren Sie die Identität und das Verhalten Ihres Agenten. Alle Felder sind bearbeitbar.',
  'Name': 'Name',
  'Role': 'Rolle',
  ...
  'Test first': 'Zuerst testen',
  'Back to configure': 'Zurück zur Konfiguration',
  'AI': 'KI',
  'Test': 'Test',
  'e.g., A friendly cooking assistant who specializes in Italian cuisine and can suggest wine pairings...': 'z.B. Ein freundlicher Kochassistent, der auf italienische Küche spezialisiert ist und Weinempfehlungen geben kann...',
  'Detailed instructions for the agent\u2019s behavior, personality, skills, constraints, and goals...': 'Detaillierte Anweisungen für Verhalten, Persönlichkeit, Fähigkeiten, Einschränkungen und Ziele des Agenten...',
  ...
  'Chat view': 'Chat-Ansicht',
  'Frames view': 'Rahmen-Ansicht',
  'Example prompts': 'Beispiel-Prompts',
  'Describe the agent\u2019s role...': 'Beschreiben Sie die Rolle des Agenten...',
  'Write the agent\u2019s system instructions...': 'Schreiben Sie die Systemanweisungen des Agenten...',
  ...
  'No connectors linked': 'Keine Konnektoren verknüpft',
  'No knowledge items assigned': 'Keine Wissenselemente zugewiesen',
  'No memories yet \u2014 this agent will learn from conversations': 'Noch keine Erinnerungen \u2014 dieser Agent lernt aus Gesprächen',
  'What this agent remembers': 'Woran sich dieser Agent erinnert',
  'No skills assigned': 'Keine Fähigkeiten zugewiesen',
  'Active': 'Aktiv',
  'Inactive': 'Inaktiv',
  'No tools configured': 'Keine Tools konfiguriert',
  'Delete this agent? This cannot be undone.': 'Diesen Agenten löschen? Dies kann nicht rückgängig gemacht werden.',
  'Previous': 'Zurück',
  'Next': 'Weiter',
  '{current} of {total}': '{current} von {total}',
  'Profile': 'Profil',
  'Playground': 'Spielwiese',
  'Esc to cancel \u00b7 click outside to save': 'Esc zum Abbrechen \u00b7 außerhalb klicken zum Speichern',
  'Test {name}': '{name} testen',
  'Send a message to try this agent. Nothing is saved.': 'Senden Sie eine Nachricht, um diesen Agenten zu testen. Nichts wird gespeichert.',
  'Lower values produce focused and deterministic output. Higher values increase creativity and variation.': 'Niedrige Werte erzeugen fokussierte und deterministische Ergebnisse. Höhere Werte erhöhen Kreativität und Variation.',
