...
export const de: I18n = {
  ...
  'Filter skills…': 'Fähigkeiten filtern…',
  ...
  Web: 'Web',
  Agent: 'Agent',
  'Image & video generation': 'Bild- und Videogenerierung',
  'Create a web app': 'Web-App erstellen',
  'Create an agent': 'Agent erstellen',
  'Describe the image or video you want to create…':
    'Beschreiben Sie das Bild oder Video, das Sie erstellen möchten…',
  'Describe the web app you want to build…':
    'Beschreiben Sie die Web-App, die Sie erstellen möchten…',
  'Describe the AI agent you want to create…':
    'Beschreiben Sie den KI-Agenten, den Sie erstellen möchten…',
  'Live voice conversation': 'Live-Sprachgespräch',
  'Listening…': 'Hört zu…',
  ...
  Input: 'Eingabe',
  Output: 'Ausgabe',
  'Older models': 'Ältere Modelle',
  Deprecated: 'Veraltet',
  Beta: 'Beta',
  Alpha: 'Alpha',
  'Knowledge cutoff': 'Wissensgrenze',
  Released: 'Veröffentlicht',
  'Open weights': 'Offene Gewichte',
  'Structured output': 'Strukturierte Ausgabe',
  'Structured JSON output support':
    'Unterstützung für strukturierte JSON-Ausgabe',
  Attachments: 'Anhänge',
  'File attachment support': 'Dateianhang-Unterstützung',
  Audio: 'Audio',
  'Audio input/output support': 'Audio-Ein-/Ausgabe-Unterstützung',
  ...
  'reasoning-focused': 'denkfokussiert',
  'fast and lightweight': 'schnell und leicht',
  ...
  'structured output': 'strukturierte Ausgabe',
  'with a very large context window': 'mit sehr großem Kontextfenster',
  'with a large context window': 'mit großem Kontextfenster',
  'General-purpose model': 'Allzweckmodell',
  ...
  'Configure your AI provider': 'Konfigurieren Sie Ihren LLM-Anbieter',
  ...
  'Prompt copied to clipboard': 'Prompt in Zwischenablage kopiert',
  ...
  'Edit agent appearance': 'Agent-Erscheinungsbild bearbeiten',
  'Edit Appearance': 'Erscheinungsbild bearbeiten',
  'Appearance updated successfully':
    'Erscheinungsbild erfolgreich aktualisiert',
  ...
  'Synced with {count} peer(s)': 'Synchronisiert mit {count} Peer(s)',
  'Synced, waiting for peers': 'Synchronisiert, wartet auf Peers',
  'Connecting...': 'Verbinden...',
  'Sync error': 'Synchronisierungsfehler',
  Room: 'Raum',
  'Last sync': 'Letzte Synchronisierung',
  'Manage sync in Settings': 'Synchronisierung in den Einstellungen verwalten',

  // Identity & State
  Guest: 'Gast',
  Synchronization: 'Modus der Synchronisation',
  Sync: 'Modus',
  ...
  'Browse all presets': 'Alle Voreinstellungen durchsuchen',
  'Image Presets': 'Bildvoreinstellungen',
  ...
  Current: 'Aktuell',
  History: 'Verlauf',
  'History sections': 'Verlauf-Bereiche',
  'Your library, tasks, and conversations in one place':
    'Ihre Bibliothek, Aufgaben und Konversationen an einem Ort',
  Clear: 'Löschen',
  ...
  'Secure (Non-extractable)': 'Sicher (Nicht-extrahierbar)',
  ...
  'Your encryption key is stored securely using non-extractable browser cryptography. The key cannot be read or exported—it can only be used for encryption operations.':
    'Ihr Verschlüsselungsschlüssel wird sicher mit nicht-extrahierbarer Browser-Kryptographie gespeichert. Der Schlüssel kann nicht gelesen oder exportiert werden—er kann nur für Verschlüsselungsoperationen verwendet werden.',
  'Non-extractable keys provide maximum security - they cannot be stolen even if an attacker gains access to your browser':
    'Nicht-extrahierbare Schlüssel bieten maximale Sicherheit - sie können nicht gestohlen werden, selbst wenn ein Angreifer Zugriff auf Ihren Browser erhält',
  'Your encryption key is stored securely and cannot be extracted for maximum security':
    'Ihr Verschlüsselungsschlüssel wird sicher gespeichert und kann für maximale Sicherheit nicht extrahiert werden',

  // Background Automation (Phase 7)
  'Background queue': 'Hintergrund-Warteschlange',
  ...
  'Task queued for background execution':
    'Aufgabe zur Hintergrundausführung in die Warteschlange gestellt',
  'Waiting for approval': 'Warten auf Genehmigung',
  'Task scheduled': 'Aufgabe geplant',
  Queue: 'Warteschlange',
  'Scheduler running': 'Planer läuft',
  'Background tasks': 'Hintergrundaufgaben',
  'Keep tab open for background tasks to complete':
    'Tab geöffnet lassen, damit Hintergrundaufgaben abgeschlossen werden',
  'Pending approval': 'Genehmigung ausstehend',
  'Background task completed': 'Hintergrundaufgabe abgeschlossen',
  'Background task failed': 'Hintergrundaufgabe fehlgeschlagen',
  'Fire and forget': 'Starten und vergessen',
  'Require approval': 'Genehmigung erforderlich',
  'Under budget only': 'Nur innerhalb des Budgets',
  Schedule: 'Zeitplan',
  Interval: 'Intervall',
  'Cron expression': 'Cron-Ausdruck',
  'Max executions': 'Maximale Ausführungen',
  'No limit': 'Kein Limit',
  'Next run': 'Nächste Ausführung',
  'Executions completed': 'Ausführungen abgeschlossen',
  'Queue statistics': 'Warteschlangen-Statistiken',
  ...
  'After decomposition': 'Nach der Zerlegung',
  'Before synthesis': 'Vor der Synthese',
  'On budget exceed': 'Bei Budgetüberschreitung',
  'Budget threshold': 'Budgetschwelle',
  Rejected: 'Abgelehnt',
  Pending: 'Ausstehend',
  'Review required': 'Überprüfung erforderlich',
  'Approve all': 'Alle genehmigen',
  'Reject all': 'Alle ablehnen',
  'This tab is the scheduler leader': 'Dieser Tab ist der Planer-Leader',
  ...
  'Working…': 'Arbeitet…',
  'file(s)': 'Datei(en)',
  'Creating agent…': 'Agent wird erstellt…',
  'Agent creation failed': 'Agenterstellung fehlgeschlagen',
  'Building app…': 'App wird erstellt…',
  'App build failed': 'App-Erstellung fehlgeschlagen',
  'is thinking…': 'denkt nach…',
  'Turn failed': 'Runde fehlgeschlagen',
  'Generating media…': 'Medium wird generiert…',
  'Generation failed': 'Generierung fehlgeschlagen',
  'Media generated': 'Medium generiert',
  'Orchestrating task…': 'Aufgabe wird orchestriert…',
