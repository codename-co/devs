...
export const ar: I18n = {
  ...
  'Edited during review': 'تم التعديل أثناء المراجعة',
  'Failed to load agent memories': 'فشل في تحميل ذاكرات الوكيل',
  'Failed to load memories': 'فشل في تحميل الذكريات',
  'Failed to create memory': 'فشل في إنشاء الذاكرة',
  'Failed to update memory': 'فشل في تحديث الذاكرة',
  'Failed to delete memory': 'فشل في حذف الذاكرة',
  'Failed to load learning events': 'فشل في تحميل أحداث التعلم',
  'Failed to update memory document': 'فشل في تحديث مستند الذاكرة',
  '{count} memories approved': 'تم اعتماد {count} ذكريات',
  'Failed to bulk approve memories': 'فشل في الاعتماد الجماعي للذكريات',
  '{count} memories rejected': 'تم رفض {count} ذكريات',
  'Failed to bulk reject memories': 'فشل في الرفض الجماعي للذكريات',
  'Memory upgraded to global': 'تمت ترقية الذاكرة إلى عالمية',
  'Memory downgraded from global': 'تم تخفيض الذاكرة من عالمية',
  ...
  'Drop reference image here…': 'أسقط صورة المرجع هنا…',
  'Describe the image you want to create…': 'صف الصورة التي تريد إنشاءها…',
  'Image presets': 'إعدادات الصورة المسبقة',
  ...
  'Browse all presets': 'تصفح جميع الإعدادات',
  'Image Presets': 'إعدادات الصور المسبقة',
  'Search presets...': 'البحث في الإعدادات...',
  All: 'الكل',
  Photo: 'صورة',
  Art: 'فن',
  Concept: 'مفهوم',
  Social: 'اجتماعي',
  Custom: 'مخصص',
  'No presets found': 'لم يتم العثور على إعدادات',
  'Image Settings': 'إعدادات الصورة',
