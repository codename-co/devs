...
export const ko: I18n = {
  ...
  Web: '웹',
  Agent: '에이전트',
  'Image & video generation': '이미지 및 비디오 생성',
  'Create a web app': '웹 앱 만들기',
  'Create an agent': '에이전트 만들기',
  'Describe the image or video you want to create…':
    '만들고 싶은 이미지나 비디오를 설명하세요…',
  'Describe the web app you want to build…': '만들고 싶은 웹 앱을 설명하세요…',
  'Describe the AI agent you want to create…':
    '만들고 싶은 AI 에이전트를 설명하세요…',
  'Live voice conversation': '실시간 음성 대화',
  'Listening…': '듣는 중…',
  ...
  Beta: '베타',
  Alpha: '알파',
  'Knowledge cutoff': '지식 마감',
  Released: '출시됨',
  'Open weights': '오픈 가중치',
  'Structured output': '구조화된 출력',
  'Structured JSON output support': '구조화된 JSON 출력 지원',
  Attachments: '첨부파일',
  'File attachment support': '파일 첨부 지원',
  Audio: '오디오',
  'Audio input/output support': '오디오 입출력 지원',
  'Cache read': '캐시 읽기',
  'Cache write': '캐시 쓰기',
  input: '입력',
  output: '출력',
  ...
  'reasoning-focused': '추론 중심',
  'fast and lightweight': '빠르고 가벼움',
  flagship: '플래그십',
  'cost-efficient': '비용 효율적',
  ...
  'tool use': '도구 사용',
  'structured output': '구조화된 출력',
  'with a very large context window': '매우 큰 컨텍스트 윈도우',
  'with a large context window': '큰 컨텍스트 윈도우',
  'General-purpose model': '범용 모델',
  'suited for': '적합한 용도',
  ...
  'Memory updated': '메모리가 업데이트됨',
  'Add a note': '메모 추가',
  'Edit memory': '메모리 편집',
  'Write what this agent should remember, as short notes…': '이 에이전트가 기억해야 할 내용을 짧은 메모로 작성하세요…',
  ...
  'Remember for this agent': '이 에이전트에 기억',
  'Remember for all agents': '모든 에이전트에 기억',
  'Remember selection': '선택 항목 기억',
  'Selection actions': '선택 작업',
  'Added to this agent’s memory': '이 에이전트의 메모리에 추가됨',
  'Added to global memory': '전역 메모리에 추가됨',
  'Failed to save to memory': '메모리에 저장하지 못했습니다',
  'No agent selected for this memory': '이 메모리에 대한 에이전트가 선택되지 않음',
  ...
  'Task queued for background execution':
    '백그라운드 실행을 위해 작업이 대기열에 추가됨',
  'Waiting for approval': '승인 대기 중',
  'Task scheduled': '작업이 예약됨',
  Queue: '대기열',
  'Scheduler running': '스케줄러 실행 중',
  'Background tasks': '백그라운드 작업',
  'Keep tab open for background tasks to complete':
    '백그라운드 작업이 완료되려면 탭을 열어 두세요',
  'Pending approval': '승인 대기',
  'Background task completed': '백그라운드 작업 완료',
  'Background task failed': '백그라운드 작업 실패',
  'Fire and forget': '실행 후 잊기',
  'Require approval': '승인 필요',
  'Under budget only': '예산 내에서만',
  Schedule: '일정',
  Interval: '간격',
  'Cron expression': 'Cron 표현식',
  'Max executions': '최대 실행 횟수',
  'No limit': '제한 없음',
  'Next run': '다음 실행',
  'Executions completed': '완료된 실행',
  'Queue statistics': '대기열 통계',
  Queued: '대기 중',
  Running: '실행 중',
  Scheduled: '예약됨',
  Completed: '완료됨',
  ...
  Normal: '보통',
  Background: '백그라운드',
  'Before execution': '실행 전',
  'After decomposition': '분해 후',
  'Before synthesis': '합성 전',
  'On budget exceed': '예산 초과 시',
  'Budget threshold': '예산 임계값',
  Rejected: '거부됨',
  Pending: '대기 중',
  'Review required': '검토 필요',
  'Approve all': '모두 승인',
  'Reject all': '모두 거부',
  'This tab is the scheduler leader': '이 탭이 스케줄러 리더입니다',
  ...
  'Select a thread to preview': '미리보기할 스레드를 선택하세요',
  'to navigate': '탐색',
  'No content': '콘텐츠 없음',
  'Conversation Envelope': '대화 봉투',
  Task: '작업',
  ...
  'New agent': '새 에이전트',
  'Create a custom agent': '사용자 정의 에이전트 만들기',

  // AgentCreationWizard
  'How would you like to create your agent?': '에이전트를 어떻게 만들고 싶으신가요?',
  'Choose your preferred approach. You can always switch later.': '원하는 방법을 선택하세요. 나중에 언제든 변경할 수 있습니다.',
  'AI-Assisted': 'AI 도움',
  'Describe what kind of agent you need in plain language. AI will generate the name, role, and instructions for you.': '필요한 에이전트를 일반 언어로 설명하세요. AI가 이름, 역할, 지시사항을 생성해 드립니다.',
  'Manual Configuration': '수동 구성',
  'Set up everything yourself. Define the name, role, and instructions from scratch.': '모든 것을 직접 설정하세요. 이름, 역할, 지시사항을 처음부터 정의합니다.',
  'Describe your agent': '에이전트를 설명하세요',
  'Tell us what kind of agent you want and we\u2019ll generate its name, role, and instructions automatically.': '원하는 에이전트를 알려주시면 이름, 역할, 지시사항을 자동으로 생성해 드립니다.',
  'Generating agent...': '에이전트 생성 중...',
  'Thinking...': '생각 중...',
  'Stop': '중지',
  'Generate Agent': '에이전트 생성',
  'to generate': '생성하려면',
  'Skip to manual': '수동으로 건너뛰기',
  'Agent configuration': '에이전트 구성',
  'Define your agent\u2019s identity and behavior. All fields are editable.': '에이전트의 정체성과 행동을 정의하세요. 모든 필드를 편집할 수 있습니다.',
  'Name': '이름',
  'Role': '역할',
  'Instructions': '지시사항',
  'Agent name...': '에이전트 이름...',
  ...
  'Test first': '먼저 테스트',
  'Back to configure': '구성으로 돌아가기',
  'AI': 'AI',
  'Test': '테스트',
  'e.g., A friendly cooking assistant who specializes in Italian cuisine and can suggest wine pairings...': '예: 이탈리아 요리 전문으로 와인 페어링을 추천할 수 있는 친근한 요리 도우미...',
  'Detailed instructions for the agent\u2019s behavior, personality, skills, constraints, and goals...': '에이전트의 행동, 성격, 능력, 제약 조건 및 목표에 대한 상세 지시사항...',

  // Agent preview
  'Close (Esc)': '닫기 (Esc)',
  'Delete agent': '에이전트 삭제',
  'More actions': '더 많은 작업',
  'No actions available': '사용 가능한 작업 없음',
  'Collapse': '접기',
  'Fullscreen': '전체 화면',
  ...
  'Describe the agent\u2019s role...': '에이전트의 역할을 설명하세요...',
  'Write the agent\u2019s system instructions...': '에이전트의 시스템 지시사항을 작성하세요...',
  'Temperature': '온도',
  'Precise': '정확',
  'Balanced': '균형',
  'Creative': '창의적',
  ...
  'No connectors linked': '연결된 커넥터 없음',
  'No knowledge items assigned': '할당된 지식 항목 없음',
  'No memories yet \u2014 this agent will learn from conversations': '아직 기억이 없습니다 \u2014 이 에이전트는 대화에서 배울 것입니다',
  'What this agent remembers': '이 에이전트가 기억하는 내용',
  'No skills assigned': '할당된 스킬 없음',
  'Active': '활성',
  'Inactive': '비활성',
  'No tools configured': '구성된 도구 없음',
  'Delete this agent? This cannot be undone.': '이 에이전트를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  'Previous': '이전',
  'Next': '다음',
  '{current} of {total}': '{current} / {total}',
  'Profile': '프로필',
  'Playground': '플레이그라운드',
  'Esc to cancel \u00b7 click outside to save': 'Esc로 취소 \u00b7 바깥을 클릭하여 저장',
  'Test {name}': '{name} 테스트',
  'Send a message to try this agent. Nothing is saved.': '이 에이전트를 시험해 보려면 메시지를 보내세요. 아무것도 저장되지 않습니다.',
  'Lower values produce focused and deterministic output. Higher values increase creativity and variation.': '낮은 값은 집중적이고 결정적인 결과를 생성합니다. 높은 값은 창의성과 변화를 높입니다.',
  'Agent info': '에이전트 정보',
} as const
