...
export const fr: I18n = {
  ...
  'Select image model': 'Sélectionner le modèle d’image',
  Search: 'Rechercher',
  ...
  'Pinned only': 'Épinglées uniquement',
  ...
  'Choose from knowledge base': 'Choisir une connaissance',
  'No files found in knowledge base': 'Aucun fichier connaissance',
  'No matching files': 'Aucun fichier correspondant',
  'Filter files…': 'Filtrer les fichiers…',
  'Add files': 'Ajouter des fichiers',
  'Choose from skills': 'Utiliser des compétences',
  ...
  Vision: 'Vision',
  Tools: 'Outils',
  'Optimized for speed': 'Optimisé pour la vitesse',
  'Budget-friendly pricing': 'Tarification économique',
  'Premium pricing tier': 'Niveau de tarification premium',
  'Extended reasoning capabilities': 'Capacités de raisonnement étendues',
  'Can analyze images': 'Peut analyser des images',
  'Function calling support': 'Prise en charge des appels de fonctions',
  Free: 'Gratuit',
  'Pricing per 1M tokens': 'Tarif par 1M de tokens',
  '1M tokens': '1M de tokens',
  context: 'contexte',
  ...
  Beta: 'Bêta',
  Alpha: 'Alpha',
  'Knowledge cutoff': 'Limite de connaissance',
  Released: 'Publié',
  'Open weights': 'Poids ouverts',
  'Structured output': 'Sortie structurée',
  'Structured JSON output support': 'Prise en charge de sortie JSON structurée',
  Attachments: 'Pièces jointes',
  'File attachment support': 'Prise en charge des pièces jointes',
  Audio: 'Audio',
  'Audio input/output support': 'Prise en charge audio entrée/sortie',
  ...
  'reasoning-focused': 'axé sur le raisonnement',
  'fast and lightweight': 'rapide et léger',
  flagship: 'phare',
  'cost-efficient': 'économique',
  ...
  'structured output': 'sortie structurée',
  'with a very large context window':
    'avec une très grande fenêtre de contexte',
  'with a large context window': 'avec une grande fenêtre de contexte',
  'General-purpose model': 'Modèle polyvalent',
  ...
  'Default agents are currently hidden. You can enable them in':
    'Les agents par défaut sont actuellement masqués. Vous pouvez les activer dans',
  // AgentRunPage
  ...
  Steps: 'Étapes',
  'Agents working…': 'Agents en cours…',
  ...
  'Enter a new title': 'Entrez un nouveau titre',
  ...
  'Edit agent appearance': 'Modifier l’apparence de l’agent',
  'Edit Appearance': 'Modifier l’apparence',
  'Appearance updated successfully': 'Apparence mise à jour avec succès',
  ...
  'Synced with {count} peer(s)': 'Synchronisé avec {count} pair(s)',
  'Synced, waiting for peers': 'Synchronisé, en attente de pairs',
  'Connecting...': 'Connexion...',
  'Sync error': 'Erreur de synchronisation',
  Room: 'Salle',
  'Last sync': 'Dernière synchro',
  'Manage sync in Settings': 'Gérer la synchronisation dans les Paramètres',
  ...
  'Browse all presets': 'Parcourir tous les préréglages',
  ...
  'Higher values follow prompt more closely':
    'Des valeurs plus élevées suivent le prompt plus fidèlement',
  ...
  'From remembered context about the user':
    'Contexte mémorisé à propos de l’utilisateur',
  'From important past conversations': 'Conversations passées importantes',
  // Notifications
  ...
  // Model Selector
  'Click to load models': 'Cliquez pour charger les modèles',
  ...
  'Not initialized': 'Non initialisée',
  'Your encryption key is stored securely using non-extractable browser cryptography. The key cannot be read or exported—it can only be used for encryption operations.':
    'Votre clé de chiffrement est stockée de manière sécurisée grâce à la cryptographie non-extractible du navigateur. La clé ne peut être ni lue ni exportée—elle ne peut être utilisée que pour des opérations de chiffrement.',
  'Non-extractable keys provide maximum security - they cannot be stolen even if an attacker gains access to your browser':
    'Les clés non-extractibles offrent une sécurité maximale - elles ne peuvent pas être volées même si un attaquant accède à votre navigateur',
  'Your encryption key is stored securely and cannot be extracted for maximum security':
    'Votre clé de chiffrement est stockée de manière sécurisée et ne peut pas être extraite pour une sécurité maximale',

  // Background Automation (Phase 7)
  'Background queue': 'File d’attente en arrière-plan',
  ...
  'Task queued for background execution':
    'Tâche mise en file d’attente pour exécution en arrière-plan',
  'Waiting for approval': 'En attente d’approbation',
  'Task scheduled': 'Tâche planifiée',
  Queue: 'File d’attente',
  'Scheduler running': 'Planificateur en cours d’exécution',
  'Background tasks': 'Tâches en arrière-plan',
  'Keep tab open for background tasks to complete':
    'Gardez l’onglet ouvert pour que les tâches en arrière-plan se terminent',
  'Pending approval': 'Approbation en attente',
  'Background task completed': 'Tâche en arrière-plan terminée',
  'Background task failed': 'Tâche en arrière-plan échouée',
  'Fire and forget': 'Lancer et oublier',
  'Require approval': 'Nécessite une approbation',
  'Under budget only': 'Dans le budget uniquement',
  Schedule: 'Planifier',
  Interval: 'Intervalle',
  'Cron expression': 'Expression Cron',
  'Max executions': 'Exécutions maximales',
  'No limit': 'Sans limite',
  'Next run': 'Prochaine exécution',
  'Executions completed': 'Exécutions terminées',
  'Queue statistics': 'Statistiques de la file d’attente',
  ...
  'Before execution': 'Avant l’exécution',
  'After decomposition': 'Après la décomposition',
  'Before synthesis': 'Avant la synthèse',
  'On budget exceed': 'En cas de dépassement du budget',
  'Budget threshold': 'Seuil de budget',
  Rejected: 'Rejeté',
  Pending: 'En attente',
  ...
  'This tab is the scheduler leader':
    'Cet onglet est le leader du planificateur',
  ...
  'Select a thread to preview': 'Sélectionnez un fil pour l\u2019aperçu',
  'to navigate': 'pour naviguer',
  'No content': 'Aucun contenu',
  'Conversation Envelope': 'Enveloppe de conversation',
  Task: 'Tâche',
