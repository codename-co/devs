...
export const fr: I18n = {
  ...
  'Member role updated': 'Rôle du membre mis à jour',
  'Member removed': 'Membre retiré',
  'You have left the workspace': 'Vous avez quitté l\'espace de travail',
  'Invite link deleted': 'Lien d\'invitation supprimé',
  'Invite link created': 'Lien d\'invitation créé',
  'Link copied to clipboard': 'Lien copié dans le presse-papiers',
  'Remove Member': 'Retirer le membre',
  'Are you sure you want to remove {name} from this workspace?':
    'Êtes-vous sûr de vouloir retirer {name} de cet espace de travail ?',
  'Leave Workspace': 'Quitter l\'espace de travail',
  'Are you sure you want to leave this workspace? You will need a new invite to rejoin.':
    'Êtes-vous sûr de vouloir quitter cet espace de travail ? Vous aurez besoin d\'une nouvelle invitation pour rejoindre.',
  Leave: 'Quitter',
  'Delete Invite Link': 'Supprimer le lien d\'invitation',
  'Are you sure you want to delete this invite link? Anyone with this link will no longer be able to join.':
    'Êtes-vous sûr de vouloir supprimer ce lien d\'invitation ? Les personnes ayant ce lien ne pourront plus rejoindre.',
  ...
  Unlimited: 'Illimité',
  Create: 'Créer',
  'No invite links': 'Aucun lien d\'invitation',
  'Create one above to invite people': 'Créez-en un ci-dessus pour inviter des personnes',
  Expired: 'Expiré',
  'Max uses reached': 'Nombre max d\'utilisations atteint',
  'Expires in {time}': 'Expire dans {time}',
  '{used}/{max} uses': '{used}/{max} utilisations',
  '{count} uses': '{count} utilisations',
  ...
  Personal: 'Personnel',
  'Shared Workspaces': 'Espaces de travail partagés',
  'No personal workspace': 'Aucun espace de travail personnel',
  'No shared workspaces yet': 'Aucun espace de travail partagé',
  'Create a workspace to collaborate with others':
    'Créez un espace de travail pour collaborer avec d\'autres',
  'Create Workspace': 'Créer un espace de travail',

  // InviteFlow - Collaboration
  'Invite to {workspace}': 'Inviter à {workspace}',
  ...
  Email: 'Email',
  'Send email invite': 'Envoyer une invitation par email',
  ...
  'Link Copied!': 'Lien copié !',
  'Copy Link': 'Copier le lien',
  'QR code downloaded': 'Code QR téléchargé',
  'QR code invite for {workspace}': 'Invitation par code QR pour {workspace}',
  'Scan to join': 'Scanner pour rejoindre',
  ...
  'Failed to send invitation': 'Échec de l\'envoi de l\'invitation',
  'Invitation Sent!': 'Invitation envoyée !',
  'An invitation has been sent to': 'Une invitation a été envoyée à',
  'Send Another': 'Envoyer une autre',
  'Email Address': 'Adresse email',
  'colleague@example.com': 'collegue@exemple.com',
  'Send Invite': 'Envoyer l\'invitation',
  'Share Invite Link': 'Partager le lien d\'invitation',
  'QR Code Invite': 'Invitation par code QR',
  'Email Invite': 'Invitation par email',
  'Generating invite...': 'Génération de l\'invitation...',
