...
export const es: I18n = {
  ...
  'Initializing model': 'Inicializando modelo',
  ...
  'Tool result': 'Resultado de herramienta',
  'No events': 'Sin eventos',
  'Select an event to view details': 'Selecciona un evento para ver detalles',
  ...
  'Global (all agents)': 'Global (todos los agentes)',
  ...
  'Select an agent to view and edit their memory':
    'Selecciona un agente para ver y editar su memoria',
  'Memory for {agent}': 'Memoria de {agent}',
  'This is what the agent remembers across conversations. It is injected at the start of every chat. Edit it freely.':
    'Esto es lo que el agente recuerda entre conversaciones. Se inserta al inicio de cada chat. Edítalo libremente.',
  'The agent has no memory yet. It will fill this in as you chat, or you can write notes here yourself.':
    'El agente aún no tiene memoria. La irá completando conforme chateas, o puedes escribir notas aquí tú mismo.',
  ...
  'Edit memory': 'Editar memoria',
  'Write what this agent should remember, as short notes…': 'Escribe lo que este agente debe recordar, en notas breves…',
  ...
  'Remember for this agent': 'Recordar para este agente',
  'Remember for all agents': 'Recordar para todos los agentes',
  'Remember selection': 'Recordar selección',
  'Selection actions': 'Acciones de selección',
  'Added to this agent’s memory': 'Añadido a la memoria de este agente',
  'Added to global memory': 'Añadido a la memoria global',
  'Failed to save to memory': 'Error al guardar en memoria',
  'No agent selected for this memory': 'Ningún agente seleccionado para esta memoria',
  ...
  'Failed to create session': 'Error al crear la sesión',

  // Workspace
  'Sub-tasks': 'Subtareas',
  'pending': 'pendiente',
  'Threads': 'Hilos',
  'Select a space': 'Seleccionar un espacio',
  ...
  'Select a thread to preview': 'Selecciona un hilo para previsualizarlo',
  'to navigate': 'para navegar',
  'No content': 'Sin contenido',
  'Conversation Envelope': 'Sobre de conversación',
  Task: 'Tarea',
  ...
  // AgentCreationWizard
  'How would you like to create your agent?': '¿Cómo te gustaría crear tu agente?',
  'Choose your preferred approach. You can always switch later.': 'Elige tu enfoque preferido. Siempre puedes cambiar después.',
  'AI-Assisted': 'Asistido por IA',
  'Describe what kind of agent you need in plain language. AI will generate the name, role, and instructions for you.': 'Describe en lenguaje sencillo qué tipo de agente necesitas. La IA generará el nombre, rol e instrucciones por ti.',
  'Manual Configuration': 'Configuración manual',
  'Set up everything yourself. Define the name, role, and instructions from scratch.': 'Configura todo tú mismo. Define el nombre, rol e instrucciones desde cero.',
  'Describe your agent': 'Describe tu agente',
  'Tell us what kind of agent you want and we\u2019ll generate its name, role, and instructions automatically.': 'Dinos qué tipo de agente quieres y generaremos su nombre, rol e instrucciones automáticamente.',
  'Generating agent...': 'Generando agente...',
  'Thinking...': 'Pensando...',
  'Stop': 'Detener',
  'Generate Agent': 'Generar agente',
  'to generate': 'para generar',
  'Skip to manual': 'Ir al modo manual',
  'Agent configuration': 'Configuración del agente',
  'Define your agent\u2019s identity and behavior. All fields are editable.': 'Define la identidad y el comportamiento de tu agente. Todos los campos son editables.',
  'Name': 'Nombre',
  'Role': 'Rol',
  ...
  'Test first': 'Probar primero',
  'Back to configure': 'Volver a configurar',
  'AI': 'IA',
  'Test': 'Prueba',
  'e.g., A friendly cooking assistant who specializes in Italian cuisine and can suggest wine pairings...': 'ej., Un asistente de cocina amigable especializado en cocina italiana que puede sugerir maridajes de vinos...',
  'Detailed instructions for the agent\u2019s behavior, personality, skills, constraints, and goals...': 'Instrucciones detalladas para el comportamiento, personalidad, habilidades, restricciones y objetivos del agente...',
  ...
  'Frames view': 'Vista de marcos',
  'Example prompts': 'Ejemplos de prompts',
  'Describe the agent\u2019s role...': 'Describe el rol del agente...',
  'Write the agent\u2019s system instructions...': 'Escribe las instrucciones del sistema del agente...',
  ...
  'No connectors linked': 'No hay conectores vinculados',
  'No knowledge items assigned': 'No hay elementos de conocimiento asignados',
  'No memories yet \u2014 this agent will learn from conversations': 'Aún no hay memorias \u2014 este agente aprenderá de las conversaciones',
  'What this agent remembers': 'Lo que este agente recuerda',
  'No skills assigned': 'No hay habilidades asignadas',
  'Active': 'Activo',
  'Inactive': 'Inactivo',
  'No tools configured': 'No hay herramientas configuradas',
  ...
  'Esc to cancel \u00b7 click outside to save': 'Esc para cancelar \u00b7 clic fuera para guardar',
  'Test {name}': 'Probar {name}',
  'Send a message to try this agent. Nothing is saved.': 'Envía un mensaje para probar este agente. Nada se guarda.',
  'Lower values produce focused and deterministic output. Higher values increase creativity and variation.': 'Los valores bajos producen resultados enfocados y deterministas. Los valores altos aumentan la creatividad y la variación.',
  'Agent info': 'Info del agente',
} as const
