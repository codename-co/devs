...
> Strategievergleich und Präsentationsfolien angehängt.`,
  ...
  [`Summarize last week’s customer interviews`]: `Kundeninterviews der letzten Woche zusammenfassen`,
  [`Three themes emerged: latency, privacy, price.`]: `Drei Themen haben sich herauskristallisiert: Latenz, Datenschutz, Preis.`,
  [`New task`]: `Neue Aufgabe`,
  [`Start a new task`]: `Neue Aufgabe starten`,
  [`Research`]: `Recherche`,
}
