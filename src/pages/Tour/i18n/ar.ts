...
> مقارنة الاستراتيجيات وشرائح العرض مرفقة.`,
  ...
  [`Benchmarks complete. Transformers.js leads on cold start.`]: `اكتملت المقارنات. Transformers.js يتصدر عند البدء البارد.`,
  [`Summarize last week’s customer interviews`]: `لخّص مقابلات العملاء للأسبوع الماضي`,
  [`Three themes emerged: latency, privacy, price.`]: `برزت ثلاثة محاور: الزمن، والخصوصية، والسعر.`,
  [`New task`]: `مهمة جديدة`,
  [`Start a new task`]: `ابدأ مهمة جديدة`,
  [`Research`]: `بحث`,
  [`Speed`]: `السرعة`,
  [`Normal`]: `عادي`,
  [`Language`]: `اللغة`,
