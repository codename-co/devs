/**
 * FilesSection — Knowledge Base section for managing files.
 *
 * Displays:
 *  - Drag & drop upload area
 *  - Watched/synced folders management
 *  - Filterable, paginated knowledge items list
 *  - Item editing, reprocessing, and bulk operations
