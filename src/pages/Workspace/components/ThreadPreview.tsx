...
export const ThreadPreview = memo(function ThreadPreview({
  ...
  // Auto-scroll to bottom when content grows and user is near the bottom.
  // Uses a ResizeObserver on the inner content so it works regardless of
  // which child (SessionPreviewContent, feed messages, etc.) is growing.
    ...
    <div className={containerClass}>
      ...
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <ToolbarBtn
                ...
                tooltip={isStarred ? t('Unstar') : t('Star')}
                className={isStarred ? 'text-warning-500' : undefined}
              />
              {onToggleTranscript && (
                <ToolbarBtn
                  icon={mode === 'transcript' ? 'ChatLines' : 'KeyframesCouple'}
                  onClick={onToggleTranscript}
                  tooltip={t(
                    mode === 'transcript' ? 'Chat view' : 'Frames view',
                  )}
                />
              )}
        ...
        {mode === 'transcript' ? (
          ...
          >
            <div ref={contentRef} className="flex flex-col pb-6">
