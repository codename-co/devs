    ...
    <ScrollShadow hideScrollBar className="min-h-0 flex-1 overflow-y-auto">
      <div className="flex flex-col gap-4 py-1">
        ...
        <TextArea
          ...
          variant="secondary"
          value={description}
          placeholder="e.g., A friendly cooking assistant who specializes in Italian cuisine and can suggest wine pairings..."
          rows={4}
      ...
      <ScrollShadow hideScrollBar className="min-h-0 flex-1 overflow-y-auto">
        <div className="flex flex-col gap-5 py-1">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-muted text-xs leading-relaxed">
              Define your agent&apos;s identity and behavior. All fields are
              editable.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <TextArea
              ...
              placeholder="Detailed instructions for the agent's behavior, personality, skills, constraints, and goals..."
              rows={8}
              onChange={(e) =>
