export const en = [
  ...
  'Architecture',
  'Browser-native PWA',
  'Desktop app (Vue + Node.js)',

  // Lemon AI — Feature table
  'Apache 2.0',
  'No (desktop app)',
  'Yes (Docker sandbox)',
  'Partial (local LLM only)',
  'Self-evolving',
  'Free + subscription',
  ...
  'Yes (via LiteLLM)',
  'Limited',
  'Multiple (via LiteLLM)',
  'Zero Infrastructure',
  'Requires Docker + Supabase',
  ...
  // LlamaPen — TL;DR
  'Browser UI for Ollama',

  // LlamaPen — Feature table
  'Provider Support',
  '6+ providers (cloud + local)',
  'Ollama only',
  'Yes (Ollama web UI)',
  'Yes (PWA)',
