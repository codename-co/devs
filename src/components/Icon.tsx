...
const CustomIcons = {
  Cubes: (props: any) => (
    ...
    >
      ...
      <use href="#cube" transform="translate(5.333 -0.133) scale(0.5556)"></use>
      <use
        href="#cube"
        transform="translate(-0.167 10.867) scale(0.5556)"
      ></use>
      <use
        href="#cube"
        transform="translate(10.833 10.867) scale(0.5556)"
      ></use>
    </svg>
  ),
...
export const Icons = {
  ...
  ShieldCheck: IconoirIcons.ShieldCheck,
  ...
  // HexagonPlus: IconoirIcons.HexagonPlus,
