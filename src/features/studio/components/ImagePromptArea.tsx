...
export const ImagePromptArea = forwardRef<HTMLTextAreaElement, ImagePromptAreaProps>(
  function ImagePromptArea(
    ...
    const settingsBadge = useMemo(() => {
      if (activePreset) {
        return activePreset.icon ? `${activePreset.icon} ${activePreset.name}` : activePreset.name
      }
      if (settings) {
        const parts = []
      ...
      >
        <div className="relative rounded-lg">
            ...
            <div className="absolute -top-16 left-2 z-20">
              <div className="relative group">
                <img
                  ...
                  alt="Reference"
                  className="h-14 w-14 object-cover rounded-lg border-2 border-default-200"
                />
                <button
                  type="button"
          ...
          <Textarea
            ...
            classNames={{
              input: 'p-1',
              inputWrapper: 'shadow-none -mb-16 pb-8 bg-default-200 !ring-0 !ring-offset-0',
            }}
            maxRows={5}
            ...
            <div className="flex flex-wrap justify-between items-end gap-1">
              ...
              <div className="flex items-center gap-1">
                ...
                <Tooltip content={t('Image settings')} placement="bottom">
                  ...
                  >
                    <Icon name="Settings" size="sm" className="text-default-500" />
                  </Button>
                </Tooltip>
                ...
                <Tooltip content={t('Add reference image')} placement="bottom">
                  ...
                  >
                    <Icon name="MediaImage" size="sm" className="text-default-500" />
                  </Button>
                </Tooltip>
                ...
                {availableProviders.length > 0 && (
                  <Dropdown>
                    <DropdownTrigger>
                      ...
                      >
                        <span className="text-xs truncate max-w-24">
                          {model
                            ? IMAGE_MODELS_BY_PROVIDER[provider || 'openai']?.find(
                                (m) => m.id === model,
                              )?.name || model
                            : t('Select model')}
                        </span>
                    ...
                    <DropdownMenu
                      ...
                      selectedKeys={model ? new Set([`${provider}:${model}`]) : new Set()}
                    ...
                    >
                      {availableProviders.map((prov) => (
                        <DropdownSection
                          ...
                          showDivider={availableProviders.indexOf(prov) < availableProviders.length - 1}
                        >
